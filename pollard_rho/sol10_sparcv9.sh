...
$CC $CFLAGS $CPPFLAGS -I/usr/local/include -c -o mpfr_set_str.o mpfr_set_str.c
$CC $CFLAGS $CPPFLAGS -I/usr/local/include -c -o pr.o pr.c
$CC $CFLAGS $CPPFLAGS -I/usr/local/include -c -o pr_mpfr.o pr_mpfr.c
$CC $CFLAGS $CPPFLAGS -I/usr/local/include -c -o pr_mpfr_quiet.o pr_mpfr_quiet.c
$CC $CFLAGS $CPPFLAGS -I/usr/local/include -c -o pr_quiet.o pr_quiet.c

ls -lapb *.o
/usr/bin/printf "\n"

$CC $CFLAGS $CPPFLAGS -Wl,-rpath=/usr/local/lib -L/usr/local/lib -o mpfr_set_str mpfr_set_str.o -lgmp -lm -lmpfr
$CC $CFLAGS $CPPFLAGS -L/usr/local/lib -o pr pr.o
$CC $CFLAGS $CPPFLAGS -L/usr/local/lib -o pr_mpfr pr_mpfr.o -lgmp -lm -lmpfr
$CC $CFLAGS $CPPFLAGS -L/usr/local/lib -o pr_mpfr_quiet pr_mpfr_quiet.o -lgmp -lm -lmpfr
$CC $CFLAGS $CPPFLAGS -L/usr/local/lib -o pr_quiet pr_quiet.o -lm

ls -lapb mpfr_set_str pr pr_mpfr pr_mpfr_quiet pr_quiet
